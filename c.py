...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7787261970:AAFNTdsCyYs93lpj-VMQ9th2f_x-REs3wlQ'
OWNER_ID = 529691217 # 👈 Put your real Telegram user ID here
CO_OWNERS = []  # List of user IDs for co-owners
OWNER_CONTACT = "Contact to buy keys"
ALLOWED_GROUP_IDS = [-1003027405720]
MAX_THREADS = 1000
max_duration = 120
bot_open = False
OWNER_USERNAME = "Demon_Rocky"
...
application = Application.builder().token("7787261970:AAFNTdsCyYs93lpj-VMQ9th2f_x-REs3wlQ").build()
